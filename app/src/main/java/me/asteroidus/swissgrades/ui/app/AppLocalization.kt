...
data class AppStrings(
    ...
    val gradeImpactTitle: String,
    val gradeImpactWithGrade: String,
    val gradeImpactWithoutGrade: String,
    val gradeImpactDelta: String,
    val gradeImpactUnavailable: String,
    ...
    companion object {
        val English = AppStrings(
            ...
            gradeImpactTitle = "Current impact",
            gradeImpactWithGrade = "With this grade",
            gradeImpactWithoutGrade = "Without this grade",
            gradeImpactDelta = "Official average change",
            gradeImpactUnavailable = "Without this grade, the official average cannot be calculated.",
        ...
        val French = AppStrings(
            ...
            gradeImpactTitle = "Impact actuel",
            gradeImpactWithGrade = "Avec cette note",
            gradeImpactWithoutGrade = "Sans cette note",
            gradeImpactDelta = "Variation de la moyenne officielle",
            gradeImpactUnavailable = "Sans cette note, la moyenne officielle ne peut pas être calculée.",
